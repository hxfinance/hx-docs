...
HX Finance runs a dual points system to ensure transparency and flexibility:

- **Standard Points**: Traditional database-tracked points for UI display
- **HXP (On-chain Points)**: Blockchain-recorded points for transparency
- **Both systems run in parallel** with identical earning rates
- **Future trading potential** for HXP tokens

### Why Two Systems?
- **Redundancy**: Ensures points are never lost
- **Transparency**: On-chain verification available
- **Future Features**: HXP may become tradeable
- **User Choice**: Both convert to hx.finance tokens at TGE
