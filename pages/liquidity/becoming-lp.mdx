...
But if earned $200 in fees, still profitable!
```
...
### Ignoring Gas Costs
- Frequent adjustments eat profits
...
**Q: Can I lose money?**
A: Yes, through impermanent loss, but fees often compensate

**Q: How often should I collect fees?**
A: When fees > gas costs, typically weekly/monthly
...
- [Managing Positions](/docs/liquidity/managing-positions)
- [Understanding Fees](/docs/liquidity/understanding-fees)
- [Advanced LP Strategies](/docs/liquidity/advanced-strategies)
- [Calculating Returns](/docs/liquidity/calculating-returns)