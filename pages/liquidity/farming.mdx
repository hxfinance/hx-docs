...
|------|---------|-----|-------------------|--------------|
| WHYPE/USDE | HX Points | Variable | 1x | Full range or concentrated |
| USDE/UBTC | HX Points | Variable | 1x | Any range |
| BUDDY/USDE | HX Points | Variable | 1x | Any range |
| LHYPE/USDE | HX Points | Variable | 1x | Any range |
...
(Note: All multipliers are currently 1x)
```
...
With 1x multiplier: 100 points/day
With Diamond tier (1x): 100 points/day
Monthly total: 3,000 points
```
