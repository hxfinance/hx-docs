...
Proof of Innocence is Moonswap's innovative compliance mechanism that allows users to trade privately while ensuring they are not on any sanctions lists. It's a zero-knowledge proof that demonstrates you are **NOT** in a sanctions database without revealing your actual identity.
...
- Your wallet is connected to Moonswap
...
1. **Navigate to Private Trading**
   - Click on the "Private Trading" section in the Moonswap interface
...
A: This is extremely rare, but if it occurs, you'll need to resolve it with the relevant authorities. Moonswap cannot override sanctions listings.