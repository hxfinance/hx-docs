...
const { generateCommitment } = require('@moonswap/privacy-sdk');
...
```
  ...
  <Tabs.Tab>
```python
# Example: Generating proofs
from moonswap_privacy import ProofGenerator

def generate_trade_proof(commitment, nullifier, token_in, token_out, amount):
    generator = ProofGenerator()
    
    proof = generator.create_trade_proof(
        commitment=commitment,
        nullifier=nullifier,
        token_in_id=token_in,
        token_out_id=token_out,
        amount_in=amount,
...
<Callout type="success">
  For the latest updates and detailed implementation code, visit our [GitHub repository](https://github.com/moonswap/privacy-contracts).
</Callout>